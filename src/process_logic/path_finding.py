...
class PathFinding:
        ...
        while not open_set.empty():
            ...
            for neighbor in current_cell.neighbors_list:
                ...
                if temp_g_score < g_score[neighbor.cell_id]:
                    ...
                    f_score[neighbor.cell_id] = temp_g_score + self.calculate_h_score(neighbor.cell_coordinates, end_cell.cell_coordinates)
    ...
    def update_neighbors_for_complete_layout(self):
        for index, row in enumerate(self.production_layout):
            for cell in row:
                self.update_cell_neighbors_list(Coordinates(cell.cell_coordinates.x, index))
    ...
    def update_cell_neighbors_list(self, cell_position: Coordinates):
        ...
        cell.neighbors_list = self.cell_neighbors_list
